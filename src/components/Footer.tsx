      ...
      <div className="container footer-grid">
        <div className="footer-brand">
          ...
          <div className="social-links">
            <a href="https://in.linkedin.com/company/machinga" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            ...
            <a href="https://www.instagram.com/wearemachinga/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
